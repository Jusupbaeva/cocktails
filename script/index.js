...
const API_GET_DETAIL = `${API}lookup.php?i=` // + idCocktail
...
const renderOneCocktail=(cocktail)=>{
    ...
    descr.className = 'descr_2'
    let glass = document.createElement('b')
    glass.className = 'glass_2'
...
// 2 - отобразить кнопку назад, которая просто вызевет функцию getAllCocktails
